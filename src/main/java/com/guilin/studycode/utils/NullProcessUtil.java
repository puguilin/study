...
public class NullProcessUtil {
	...
	public static boolean isNull(String obj){
		String reg = "^\\s*$";
		return (obj==null || "null".equals(obj) || "".equals(obj) || obj.matches(reg))?true:false;
	}
	public static boolean isObjNull(Object obj){
		String reg = "^\\s*$";
		return (obj==null || "null".equals(obj) || "".equals(obj))?true:false;
	}
	
	public static String valiadateParam(Map<String,String> map){
		ObjectMapper objectMapper = new ObjectMapper();
		String returnStr = "";
		for(String name:map.keySet()){
            if(NullProcessUtil.isNull(map.get(name))){
				Map<String,String> out = new HashMap<String,String>();
				out.put("code", "4444");
				out.put("msg", name + " is required!");
				try {
					returnStr= objectMapper.writeValueAsString(out);
