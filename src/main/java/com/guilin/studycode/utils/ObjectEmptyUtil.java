...
public class ObjectEmptyUtil {
        ...
        /**
         * 判断字符串是否为空 PS: 为空的条件： 1. String对象为空 2. 没有任何字符的字符串
         *
         * @param str 需要判断的字符串
        ...
        /**
         * 判断集合是否为空 PS： 集合为空的条件： 1. 集合对象为null 2. 集合中没有元素
         *
        ...
        public static boolean isEmpty(Iterable<?> iterable) {
            return null == iterable || Lists.newArrayList(iterable).size() == 0;
        }
        ...
        /**
         * 判断对象数组是否为空 PS： 对象数组为空的条件： 1. 对象数组为null 2. 对象数组中没有元素
         *
        ...
        /**
         * 判断数组是否为空 PS： 数组为空的条件： 1. 数组为null 2. 数组中没有元素
         *
